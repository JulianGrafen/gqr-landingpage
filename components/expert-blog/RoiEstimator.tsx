...
export function RoiEstimator() {
 ...
 Annahme: ca. {ROI_MANUAL_MINUTES_PER_SDB} Min. pro Sicherheitsdatenblatt für Erfassung,
 ...
 <p className="mt-1 text-xs text-[#8fa4c0]">
 Annahme: ca. {ROI_GQR_MINUTES_PER_SDB} Min. pro Sicherheitsdatenblatt inkl. KI-Import
