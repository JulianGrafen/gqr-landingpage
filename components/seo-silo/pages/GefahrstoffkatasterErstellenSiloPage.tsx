...
export function GefahrstoffkatasterErstellenSiloPage() {
 ...
 <p>
 <strong>Die operative Realität für die Sicherheitsfachkraft:</strong> Es reicht nicht aus, darauf zu warten, dass der Lieferant ein neues Fass mit einem neuen Etikett auf den Hof stellt. Die SiFa muss aktiv sicherstellen, dass die neuen Sicherheitsdatenblätter im Betrieb vorliegen, die neuen H-Sätze (Gefahrenhinweise) in das Gefahrstoffkataster übernommen werden und – das ist der kritische Punkt – die bestehenden Betriebsanweisungen sowie die Gefährdungsbeurteilungen aktualisiert werden.
 </p>
 <p>
 ...
 Eine Betriebsanweisung zu schreiben, ist lediglich der erste Schritt. Die nachweisliche, arbeitsplatzbezogene Unterweisung der Belegschaft ist der entscheidende zweite Schritt. Wenn H- und P-Sätze aufgrund eines neuen Sicherheitsdatenblätter angepasst werden, muss das Team zwingend nachgeschult werden. Ohne ein System, das solche Änderungen im Kataster protokolliert und die Verantwortlichen proaktiv alarmiert, arbeiten Mitarbeiter am Band schnell nach veralteten und potenziell gefährlichen Schutzmaßnahmen weiter.
 </p>
 <p>
