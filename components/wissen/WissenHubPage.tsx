...
export function WissenHubPage({ deepinfoPages, blogPosts }: WissenHubPageProps) {
  return (
    <main>
      <section
        className="border-b border-white/[0.07] bg-gradient-to-b from-[#0f1e35]/95 to-[#0a1628] px-4 py-14 sm:px-6 sm:py-20 lg:px-10"
        aria-labelledby="wissen-hero-title"
      >
        <div className="mx-auto max-w-[1160px]">
          <p className="text-xs font-bold uppercase tracking-wider text-[#ff6b35] sm:text-sm">
            Wissen · Blog · Deepinfo
          </p>
          <h1
            id="wissen-hero-title"
            className="mt-3 text-3xl font-black leading-tight tracking-tight text-[#f0f6ff] sm:text-4xl lg:text-[2.75rem]"
          >
            Gefahrstoff-Wissen für Betrieb, SiFa und Compliance
          </h1>
          <p className="mt-5 max-w-3xl text-lg leading-relaxed text-[#8fa4c0]">
      ...
      >
        <div className="mx-auto max-w-[1160px]">
          <header className="max-w-3xl">
            ...
            <h2
              id="wissen-deepinfo-heading"
              className="mt-2 text-2xl font-black text-[#f0f6ff] sm:text-3xl"
            >
              Fachleitfäden & Landingpages
            </h2>
            <p className="mt-3 text-base leading-relaxed text-[#8fa4c0]">
      ...
      <section
        id="wissen-blog"
        className="border-b border-white/[0.07] bg-[#0f1e35]/40 px-4 py-14 sm:px-6 sm:py-16 lg:px-10"
      ...
      >
        <div className="mx-auto max-w-[1160px] rounded-2xl border border-[#2dd4bf]/25 bg-gradient-to-br from-[#2dd4bf]/10 to-[#162340]/80 px-6 py-10 text-center sm:px-10 sm:py-12">
          <h2 className="text-2xl font-black text-[#f0f6ff] sm:text-3xl">
            Bereit für rechtssicheres Gefahrstoffmanagement?
          </h2>
          <p className="mt-3 text-[#8fa4c0]">
