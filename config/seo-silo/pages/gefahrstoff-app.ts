...
export const GEFAHrstoff_APP_SILO_CONFIG: SeoSiloPageConfig = {
  ...
  seo: {
    ...
    description:
      'Gefahrstoff App für Werkstatt und Betriebsanweisungustelle: QR-Code am Fass scannen, GHS, P-Sätze und Erste-Hilfe sofort — § 6 GefStoffV Information am Arbeitsplatz.',
    ogImageAlt:
  ...
  features: {
    ...
    sectionSubline:
      'Checkliste für Lager, Werkstatt und Betriebsanweisungustelle — abgeleitet aus § 6 GefStoffV, TRGS 400 und Ersthelfer-Praxis.',
    items: [
      {
        id: 'qr-scan',
      ...
      },
      {
        ...
        title: 'Betriebsanweisung greifBetriebsanweisungr',
        description:
  ...
  faq: [
    {
      ...
      answer:
        'Nein. GQR läuft mobil im Browser — QR-Code scannen, Stoffansicht öffnen. Das senkt die Hürde auf Betriebsanweisungustellen und in Werkstätten, wo keine zentrale App-Verteilung existiert. Voraussetzung ist Netzempfang am Scan-Ort für den Abruf der hinterlegten Daten.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Scan am betroffenen Gebinde → strukturierte Notfallansicht mit GHS, Erste-Hilfe-Maßnahmen und P-Sätzen. Ziel: keine Suche im Büro, kein Blättern in PDFs. Ersthelfer handeln nach sichtBetriebsanweisungren Maßnahmen — Geschwindigkeit reduziert Schaden.',
    },
    {
      question: 'Funktioniert das auf der Betriebsanweisungustelle und in der Werkstatt?',
      answer:
        'Ja, überall wo ein QR-Code am Gebinde oder Regal angebracht ist und mobiles Netz verfügBetriebsanweisungr ist. Typische Einsätze: Lackiererei, Kfz-Werkstatt, Betriebsanweisungucontainer-Lager, Reinigungsmittel in Gebäudereinigung. Die Information folgt dem Stoff — nicht dem Standort des Papierordners.',
    },
    {
...
export const GEFAHrstoff_APP_COMPARISON = {
  targetAudience: 'Werkstatt, Betriebsanweisungustelle und Lager mit mobilem Gefahrstoffeinsatz',
  rows: [
    {
    ...
    },
    {
      ...
      gqr: 'Digitale Betriebsanweisung über dieselbe QR-Verknüpfung erreichBetriebsanweisungr',
    },
    {
      criterion: 'Betriebsanweisungustelle / wechselnde Standorte',
