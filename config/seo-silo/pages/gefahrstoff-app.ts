...
export const GEFAHrstoff_APP_SILO_CONFIG: SeoSiloPageConfig = {
  ...
  hero: {
    ...
    lead:
      'Ein SDB auf dem Büro-Server schützt niemanden am Regal. Mit Gefahrstoff-QR scannen Beschäftigte und Ersthelfer den QR-Code am Gebinde und sehen sofort GHS-Kennzeichnung, P-Sätze und Erste-Hilfe-Maßnahmen auf dem Smartphone.',
    proofLine:
  ...
  features: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          'Kennzeichnung und Handlungshinweise aus dem hinterlegten SDB — relevant bei CLP-Anpassungen bis Mai 2026.',
      },
      {
        id: 'erste-hilfe',
        title: 'Erste-Hilfe für Ersthelfer',
        description:
          'Maßnahmen nach SDB Abschnitt 4 — strukturiert statt Blättern in 15-seitigen PDFs unter Zeitdruck.',
      },
      {
        id: 'ba',
        title: 'Betriebsanweisung greifbar',
        description:
          'Digitale BA am Einsatzort statt ausgedruckter Word-Version, die seit dem letzten Lieferantenwechsel veraltet ist.',
      },
      {
        id: 'kataster-mobil',
        title: 'Kataster mobil durchsuchen',
        description:
          'SiFa und Vorarbeiter prüfen Stoffe, Lagerorte und SDB-Status unterwegs — nicht nur am Desktop.',
      },
      {
        id: 'notruf',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Das Kataster ist das Compliance-Rückgrat — die App-Ansicht ist der Abruf vor Ort. GQR verbindet beides: SiFa pflegt zentral per KI-SDB-Import, Mitarbeiter und Ersthelfer nutzen mobilen QR-Zugang. Wer nur ein Desktop-Verzeichnis hat, löst den Einsatzort nicht.',
    },
    {
      question: 'Wie starte ich mit QR-Codes am Gebinde?',
      answer:
        'Stoff im Kataster anlegen, SDB importieren, QR-Label generieren und am Gebinde anbringen. Im kostenlosen Test können Sie den Workflow mit ersten Stoffen prüfen — ohne Kreditkarte.',
    },
  ],
  closingCta: {
  ...
  rows: [
    {
      ...
      manual: 'SDB-Ordner im Büro oder veralteter Ausdruck am Regal',
    ...
    {
      criterion: 'Aktualität bei SDB-Wechsel',
    ...
    },
    {
      ...
      gqr: 'Digitale BA über dieselbe QR-Verknüpfung erreichbar',
    },
    {
