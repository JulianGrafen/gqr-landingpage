...
export const KATASTER_SOFTWARE_SILO_CONFIG: SeoSiloPageConfig = {
 ...
 description:
 'Nachvollziehbar, wer wann welche Sicherheitsdatenblatt-Version hochgeladen oder Felder geändert hat — entscheidend bei Arbeitsunfällen und Audits.',
 },
 {
 id: 'verzeichnis',
 ...
 description:
 'Verzeichnis als Basis für Unterweisungsinhalte — weniger Word-Betriebsanweisung-Pflege, wenn Daten aus dem Sicherheitsdatenblatt zentral und aktuell liegen.',
 },
 {
 id: 'notfall',
 ...
 answer:
 'Das Verzeichnis liefert die strukturierte Stoffbasis für die GB chemischer Arbeitsstoffe: Mengen, Einsatzbereiche, Kennzeichnung, Schutzmaßnahmen aus dem Sicherheitsdatenblatt. GQR ersetzt nicht die fachliche Bewertung der SiFa — aber es reduziert die Zeit für Datensammlung und hält Informationen verknüpft statt in Excel-, Word- und PDF-Inseln.',
 },
 {
 ...
 answer:
 'Typisch: Bestands-Sicherheitsdatenblätter hochladen, extrahierte Felder prüfen, Lagerorte zuordnen — erste Stoffe oft in einem Vormittag. Kein ERP-Integrationszwang für den Start. SiFa-Zeit fließt in fachliche Freigabe, nicht in Abtippen.',
 },
 {
 ...
 subline:
 'Testen Sie GQR mit Ihren echten Sicherheitsdatenblätter — und vergleichen Sie den Pflegeaufwand mit Ihrem Excel-Kataster.',
 primaryCta: {
...
export const KATASTER_SOFTWARE_COMPARISON = {
 ...
 manual: 'Listen importieren, Spalten anpassen, Sicherheitsdatenblätter manuell verknüpfen',
 ...
 gqr: 'Daten aus dem Sicherheitsdatenblatt als Betriebsanweisung-Grundlage, Ergänzung betriebsspezifisch',
 },
 {
 criterion: 'ROI über 3 Jahre',
 manual: 'Steigende Pflegekosten mit jedem Stoff und Standort',
 gqr: 'Marginaler Mehraufwand pro neuem Sicherheitsdatenblatt — planbare SiFa-Zeit',
 },
 ],
} as const;
