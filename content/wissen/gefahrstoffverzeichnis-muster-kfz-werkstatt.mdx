...
comparison:
 ...
 manual: Daten aus dem Sicherheitsdatenblatt per Copy-Paste in ein separates Word-Muster übertragen.
 ...
 gqr: Audit-Log. Jede Sicherheitsdatenblatt-Änderung und Freigabe mit unveränderbarem Zeitstempel.
faq:
 ...
 answer: Ja. Das manuelle Suchen in Zusammenlagerungsmatrizen ist aufwendig. GQR erfasst die Lagerklassen direkt aus den hochgeladenen Sicherheitsdatenblätter und unterstützt die Zusammenlagerungslogik aktiv. Das bedeutet weniger Matrix-Suchen bei der Lagerplanung von Ölen, brennbaren Gasen und entzündlichen Bremsenreinigern.
...
- **Keine Warnfunktion bei veralteten Sicherheitsdatenblätter:** Sicherheitsdatenblätter veralten. Ein Excel-Muster schlägt keinen Alarm, wenn ein Datenblatt seit fünf Jahren nicht erneuert wurde.
...
### 2. Betriebsanweisungen mit Praxisbezug

Gemäß TRGS 555 muss die Werkstatt für Tätigkeiten mit Gefahrstoffen Betriebsanweisungen in verständlicher Form am Arbeitsplatz aushängen. GQR löst das Problem des weißen Blattes. Das System nutzt die extrahierten Daten aus dem Sicherheitsdatenblatt, um eine Betriebsanweisung zu generieren.
