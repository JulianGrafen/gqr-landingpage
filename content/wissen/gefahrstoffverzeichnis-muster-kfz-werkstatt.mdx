...
comparison:
  ...
  rows:
    - criterion: Sicherheitsdatenblatt-Erfassung bei neuen Ölen
    ...
    - criterion: Erstellung Betriebsanweisung
      manual: Sicherheitsdatenblatt-Daten per Copy-Paste in ein separates Word-Muster übertragen.
      gqr: Semi-automatische Betriebsanweisung. GQR bereitet Daten vor, Meister ergänzt werkstattspezifische Details.
    - criterion: VerfügBetriebsanweisungrkeit an der Hebebühne
      manual: Ausdrucke verschmutzen, verölen oder fehlen komplett in der Halle.
      gqr: QR-Notfallpass. Scan am Arbeitsplatz liefert Erste-Hilfe-Infos und die Betriebsanweisung.
    ...
    - criterion: Revisionssicherheit (Audit)
      ...
      gqr: Audit-Log. Jede Sicherheitsdatenblatt-Änderung und Freigabe mit unveränderBetriebsanweisungrem Zeitstempel.
faq:
  ...
  - question: Brauche ich ein separates DME-Protokoll?
    answer: DME-Anforderungen (TRGS 554) ergänzen das Gefahrstoffmanagement. Eine Trennung in separate Aktenordner ist fehleranfällig. Ein digitales System wie GQR kann das Gefahrstoffverzeichnis und emissionsbezogene Nachweise (inklusive der Betriebsanweisungen für Absauganlagen) parallel und konsistent in einer DatenBetriebsanweisungnk führen.
  - question: Hilft GQR bei TRGS 510 in der Werkstatt?
    answer: Ja. Das manuelle Suchen in Zusammenlagerungsmatrizen ist aufwendig. GQR erfasst die Lagerklassen direkt aus den hochgeladenen Sicherheitsdatenblatts und unterstützt die Zusammenlagerungslogik aktiv. Das bedeutet weniger Matrix-Suchen bei der Lagerplanung von Ölen, brennBetriebsanweisungren Gasen und entzündlichen Bremsenreinigern.
  - question: Kann ich in GQR auch Produkte mit schnellem Wechsel (z. B. verschiedene Lackfarben) effizient pflegen?
    answer: Softwarelösungen sind für Produktwechsel ausgelegt. Wird ein Produkt ausgemustert, wird es mit einem Klick rechtssicher archiviert (nicht gelöscht). Das neue Produkt wird per Sicherheitsdatenblatt-Upload in Sekunden als Ersatz angelegt, wobei die Historie für eventuelle spätere Nachfragen intakt bleibt.
---

## Der Ultimate Guide: Gefahrstoffmanagement in der Kfz-Werkstatt

Kfz-Werkstätten sind im Arbeitsalltag echte **Gefahrstoff-Hotspots**. Ob lösende Bremsenreiniger aus der Spraydose, hunderte Liter an Motorölen, aggressive Bremsflüssigkeiten, Frostschutzmittel oder Lackierstoffe – kaum ein Handwerksbetrieb hantiert mit einer vergleichBetriebsanweisungren Dichte an entzündBetriebsanweisungren, umweltgefährdenden oder gesundheitsschädlichen Chemikalien.
...
- **Keine Warnfunktion bei veralteten Sicherheitsdatenblatts:** Sicherheitsdatenblätter (Sicherheitsdatenblatt) veralten. Ein Excel-Muster schlägt keinen Alarm, wenn ein Datenblatt seit fünf Jahren nicht erneuert wurde.
...
### 4. Gase und Betriebsanweisungtterien

Schweißgase (Argon, CO₂) und Brenngase (Acetylen) sind Standard. StarterBetriebsanweisungtterien enthalten verdünnte Schwefelsäure, die ätzend wirkt, sowie Blei. Beim Laden von Betriebsanweisungtterien kann sich zudem hochexplosives Knallgas bilden.
...
## Der unsichtBetriebsanweisungre Gefahrstoff: Dieselmotoremissionen (DME)
...
- Wo steht die Kiste mit den alten StarterBetriebsanweisungtterien (Lagerklasse 8, ätzend)?
...
Hersteller von Werkstatt-Chemie (wie Würth, Liqui Moly, Fuchs oder Berner) aktualisieren ihre Sicherheitsdatenblätter regelmäßig. Mit GQR zieht der Verantwortliche das neue Sicherheitsdatenblatt-PDF per Drag & Drop in das System. Die integrierte KI-Logik (Azure Intelligence) liest die komplexen Tabellenstrukturen aus, extrahiert die GHS-Piktogramme, die H- und P-Sätze sowie die relevanten Schutzmaßnahmen und befüllt das digitale Kataster. Die manuelle Fehlerquelle Tippfehler wird eliminiert.

### 2. Betriebsanweisungen (Betriebsanweisung) mit Praxisbezug

Gemäß TRGS 555 muss die Werkstatt für Tätigkeiten mit Gefahrstoffen Betriebsanweisungen in verständlicher Form am Arbeitsplatz aushängen. GQR löst das Problem des weißen Blattes. Das System nutzt die extrahierten Sicherheitsdatenblatt-Daten, um eine Betriebsanweisung zu generieren.
...
Durch die Strukturierung der Daten weiß GQR, in welche Lagerklasse ein Produkt fällt. Wird dem System mitgeteilt, dass Bremsenreiniger und bestimmte Säuren in denselben Gefahrstoffschrank gebucht werden, schlägt das System Betriebsanweisungsierend auf der TRGS 510 Matrix Alarm. Dies schützt Inhaber vor empfindlichen Strafen bei unangekündigten Umwelt-Inspektionen.
...
2. **Sicherheitsdatenblatt-Sammel-Aktion:** Für alle verbliebenen, aktiven Produkte werden die aktuellen Sicherheitsdatenblätter von den Hersteller-Websites heruntergeladen.
3. **Der Betriebsanweisungtch-Upload:** Die PDFs werden in GQR hochgeladen. Das System übernimmt die Extraktion der Daten und Betriebsanweisungut das Grundgerüst des Gefahrstoffverzeichnisses nach § 6 GefStoffV auf.
...
5. **Betriebsanweisung-Validierung und QR-Druck:** Die Betriebsanweisungen werden durch den Meister kontrolliert, um spezifische Pflichtfelder ergänzt und freigegeben. Abschließend werden die QR-Codes ausgedruckt und an den Regalen, Waschtischen oder Absauganlagen angebracht.
...
- Archivierte Stoffe und alte Betriebsanweisungen sind jederzeit abrufBetriebsanweisungr (wichtig für die Dokumentation von Berufskrankheiten, die erst Jahre später auftreten).
- Die Verknüpfung von Sicherheitsdatenblatt, TRGS-Einstufung und tätigkeitsbezogener Betriebsanweisung ist lückenlos.
