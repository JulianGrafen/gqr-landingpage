...
const STRUC_DATA = {
 ...
 {
 '@type': 'HowToStep',
 name: 'Stoffe und Sicherheitsdatenblätter erfassen',
 ...
 text: 'Bei neuen Sicherheitsdatenblatt-Versionen Daten aktualisieren und Änderungen nachvollziehbar dokumentieren – das reduziert Haftungsrisiko und Prüfungsstress.',
 },
 ],
 },
 ],
...
export default function GefahrstoffkatasterExcelVorlagePage() {
 ...
 subtitle="Ein Muster in Excel oder als exportierbare Liste gibt Orientierung für Spalten, die in Audits oft nachgefragt werden — von Stoffbezeichnung über Kennzeichnung bis zur Quelle des Sicherheitsdatenblatt. Eine Vorlage ersetzt aber weder die fachliche Bewertung noch eine belastbare Historie von Änderungen."
 />
 ...
 <p>
 Lieferanten aktualisieren Sicherheitsdatenblätter regelmäßig. In Excel bleibt oft
 ...
 <p>
 Sicherheitsdatenblätter sind komplex; Ausnahmen, proprietäre Gemische und
 ...
 body="Starten Sie kostenlos: Struktur wie bei einer Vorlage, plus automatische Übernahme aus echten Sicherheitsdatenblätter. Keine Kreditkarte."
